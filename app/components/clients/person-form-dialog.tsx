...
export function PersonFormDialog({
  ...
  const [formData, setFormData] = useState<
    Omit<CreateClientRequest, "client_type" | "first_name" | "last_name">
  >({
    email: "",
    phone_numbers: [],
    country: "",
  ...
  const addPhoneNumber = () => {
    setPhoneNumbers([...phoneNumbers, { type: "mobile", number: "" }]);
  };
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Add Person Client</DialogTitle>
          <DialogDescription>
            Create a new individual client. Fill in the information below.
          </DialogDescription>
        </DialogHeader>
